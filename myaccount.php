...
<title>优百仓进销存</title>
<link rel=stylesheet type=text/css href="/pc/css/style.css?v=<?php echo time()?>">
...
<script type="text/javascript" src="/pc/js/common.js?v=<?php echo time()?>"></script>
<script type="text/javascript" src="/pc/js/main.js?v=<?php echo time()?>"></script>
<script type="text/javascript" src="/pc/js/component.js?v=<?php echo time()?>"></script>
...
<script type="text/html" id="pages_tpl">
    <div class="showpage">
        ...
        <span style="display:block">
            <span class="page_ele pagelink" id="last">上一页</span>
            <span class="page_ele pagelink" id="ll" />
            <span class="page_ele pageblank"  id="lb">...</span>
            <span class="page_ele pagelink" id="l2" />
            <span class="page_ele pagelink" id="l1" />
            <span class="page_ele pageselect" id="m" >1</span>
            <span class="page_ele pagelink" id="r1" />
            <span class="page_ele pagelink" id="r2" />
            <span class="page_ele pageblank"  id="rb">...</span>
            <span class="page_ele pagelink" id="rr" />
            <span class="page_ele pagelink" id="next">下一页</span>
        </span>
    </div>
</script>
<script type="text/html" id="ikeyword_tpl">
    <span style="float:left;width:12%; padding:5px 0; color:#999999; text-align:right; overflow:hidden;">货号：</span>
    <input id="qilaihai" class="ikeyword_num iinput name_iime ino_ime_input iproduct_name" style="text-align:left;color:#000; width:141px">
    <div class="ikeywords" style="position:relative;display:block;">
        <ul>
            <li class="ikey_letters" style="display:block;"></li>
        </ul>
        <ul>
            <li><span>1</span></li>
            <li><span>2</span></li>
