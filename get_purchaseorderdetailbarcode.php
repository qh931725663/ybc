...
$rsdetailbarcode = mysql_query("select * from ydf_order_detail where detail_order_bianhao='".$_REQUEST["var_order_bianhao"]."' order by detail_p_barcode_bianhao asc", $dbconn); 
