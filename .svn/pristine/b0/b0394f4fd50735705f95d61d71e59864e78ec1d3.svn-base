...
<div class="report">
    <div class="report_table_header">
        ...
        <div style="width:8%;color:#999999;margin-left:5%;"></div>
        <div style="width:8%;color:#999999;">七日均销</div>
        <div style="width:8%;color:#999999;margin-left:13%;">七日总销</div>
        <div style="width:7%;color:#999999;margin-left:15%;">操作</div>
    </div>
<!-- refresh_begin -->
...
?>
                        <div class="report_table_body" style="width:100%; margin:0 auto; padding:10px 0; border-bottom:1px dashed #cccccc; overflow:hidden; display:block;">
                            ...
                            <div class="kucun_sp" style="width:12%;margin-left:2%;"></div>
                            <div style="width:6%;"><?php echo round($avg_num) ?></div>
                            <div style="width:8%;margin-left:14%"><?php echo floatval($total_num) ?></div>
                            <div style="width:7%;margin-left:15%"><span onclick="/**/ShowStockProductGuige('<?php echo $ro["detail_p_huohao"] ?>','<?php echo $product_id ?>','<?php $factory_id ?>')" style="font-size:14px; color:#0099FF; cursor:pointer">详细</span></div>
...
{
    $("#pid_view_factory_stock_agent #pages_stock_addup").set_page_num("","",1);

    refresh_inner("view_factory_stock_agent?"+$("#form_stock_addup").serialize() );
}
</script>