    ...
    search_771();
                    ...
                    <div style="float:left; width:100%; margin-top:20px; overflow:hidden; display:block;">
                        <div style="float:left; overflow:hidden; display:block">
                            ...
                            <span id="btn_chukuorder_search" class="btn_normal_blue public_search_sm" onclick="search('view_finance_reg_cash','form_771')">搜索</span>
...
$where=@array("bill_boss_id=? and bill_factory_id=? and bill_type<>'sqyf' and bill_is_close=?
...
<!-- refresh_end -->
                    ...
                    <div id="layer_factory_getcash" style="float:left; width:500px; padding:30px; overflow:visible; display:none">
...
function ShowFactoryGetcashConfirm(bill_id){
    $.ajax({
        ...
        success: function(html){
            $("#layer_factory_getcash").html(html);
        }
    });
...
$("#factory_getcash_confirm_btn").mouseover(function(){
    $(this).css("background","#d64126");
}).mouseout(function(){
    $(this).css("background","#ee583d");
});
