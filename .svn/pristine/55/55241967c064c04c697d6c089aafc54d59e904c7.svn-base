...
<form method="post" id="products_add_form">
                    <div style="float:left; width:100%; margin-top:30px; overflow:hidden; display:block">
                        <div style="position:relative; float:left; width:100%; padding:10px 0; display:block">
                            ...
                            <div style="float:left; width:80%"><input class="iinput" id="product_huohao" name="product_huohao" type="text" size="10" maxlength="10" style="padding:5px;width:33%"></div>
                        </div>
                        <div style="position:relative; float:left; width:100%; padding:10px 0; display:block">
                            <div style="float:left; width:20%; padding:5px 0; text-align:right"><span style="color:red">*</span> 出品档口：</div>
                            <div style="float:left; width:80%"><input class="iinput" id="product_store" name="product_store" type="text" size="10" maxlength="50" style="padding:5px;width:33%"></div>
                        </div>
                        <div style="position:relative; float:left; width:100%; padding:10px 0; display:block">
                            <div style="float:left; width:20%; padding:5px 0; text-align:right"><span style="color:red">*</span> 面料成分：</div>
                            <div style="float:left; width:80%"><input class="iinput" id="product_composition" name="product_composition" type="text" size="30" maxlength="100" style="padding:5px;width:33%"></div>
                        </div>
                        <div style="position:relative; float:left; width:100%; padding:10px 0; display:block">
                        ...
                        <div style="position:relative; float:left; width:100%; padding:10px 0; display:block">
                            ...
                            <div style="float:left; width:80%"><input class="iinput" id="product_saleprice" name="product_saleprice" type="text" size="10" maxlength="10" style="padding:5px;width:33%"></div>
                        </div>
                        <div style="position:relative; float:left; width:100%; padding:10px 0; display:block">
                            <div style="float:left; width:20%; padding:5px 0; text-align:right"> 大客价：</div>
                            <div style="float:left; width:80%"><input id="product_vipprice" name="product_vipprice" type="text" size="10" maxlength="10" style="padding:5px;width:34%"></div>
                        </div>
