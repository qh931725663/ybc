                ...
                setTimeout(function(){
                    ...
                    <div style="float:left; width:100%; margin-top:20px; overflow:hidden; display:block;">
                        <div style="float:left; overflow:hidden; display:block">
                            ...
                            <span style="float:left; margin-left:10px;"><input id="applicant_name" name="applicant_name" class="iinput name_iime  " type="text" style="width:150px; padding:5px;" placeholder="请输入申请人姓名"/></span>

                            <span id="btn_chukuorder_search" class="btn_normal_blue public_search_sm" onclick="search('view_finance_reg_expence','form_721')">搜索</span>
...
@$applicant_name=$_REQUEST["applicant_name"]?$_REQUEST["applicant_name"]:null;
$p_user_a=cselect("user_self_m_bianhao","ydf_user",array("user_name=?",$applicant_name));
    $row_user_a=$p_user_a[0]->fetch();
$where=@array("bill_boss_id=? and bill_add_user_id=? and bill_user_id=? and bill_is_close=?
        ...
        $boss_id,$row_user_a["user_self_m_bianhao"],$_REQUEST["bill_user"],$_REQUEST["bill_is_close"],
...
?>
                        <div class="list_stalls report_table_body" style="position:relative;width:100%; padding:10px 0; border-bottom:1px dashed #cccccc; overflow:hidden; display:block">
                            ...
                            <div style="width:10%; color:#ee583d;"><?php echo echo2($row_bill["bill_fund"])?></div>
                            ...
                            <div style="float:left;width:100%; margin:0 auto; padding:10px 0; overflow:hidden; display:block;">
                                <div style="float:right; padding:5px 0">
                                    ...
                                    <span style="float:left; margin-left:10px; color:#0099FF; cursor:pointer" onclick="delete_bxyf_721(<?php echo $row_bill["bill_id"]?>)">撤销</span>
                                </div>
                            </div>
                            <?php
                            }
