    ...
    mount_to_frame('view_finance_bi_pool_summary',1,'frame_finance_bi_pool_summary');
                    ...
                    <div class="search_box">
                        <div class="search_box_inner">
                            ...
                            <div class="txhz_b">
                                ...
                                <span onclick="search('view_deal_finance_addup','form_deal_finance_addup')" class="btn_normal_blue">搜索</span>
                ...
                <div class="report">
                    <div class="report_table_header" style="margin-top:0px; background:#f2f2f2">
                        ...
                        <div style="width:12%; color:#999999; text-align:center">操作</div>
                    </div>
                    ...
                    ?>
                        <div class="report_table_body" style="border-bottom:1px dashed #cccccc">
                            ...
                            <div style="width:12%; text-align:center">-</div>
                            <div style="width:12%; text-align:center"></div>
                            <div style="width:13%; padding:6px 0; text-align:center"><?php echo $row["sum"]["pool"]?>
                            </div>
...
<script>/*n*/    
    $("#pid_view_deal_finance_addup #pages_deal_finance_addup").set_page_count("view_deal_finance_addup","pages_deal_finance_addup",<?php echo $page_count;?>);
</script>

<!-- refresh_end -->
    <div class="ipages" input_idx_id="#pid_view_deal_finance_addup #page_idx" id="pages_deal_finance_addup" page="view_deal_finance_addup" form="form_deal_finance_addup" count="<?php echo $page_count; ?>"/>
                     <!-- 页码也作为表单项统一处理  -->
                </div>
    ...
    /* if ($("#layer_deal_finance_detail_"+factory_id).is(":visible")==false)
    {
        $.ajax({
            ...
            success: function(html){
                $("#layer_deal_finance_detail_"+factory_id).html(html);
                $("#layer_deal_finance_detail_"+factory_id).show();
            }
        });
    }
