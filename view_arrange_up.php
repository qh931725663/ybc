    ...
    <div class="thsi_search_box">
        <div class="thsi_date_d">
            <span class="thsi_date_d1">
                <span class="date_d1_box">日期 <input type="text" class="datepicker" name="arrange_up_from_day"  size="12" maxlength="50" readonly="readonly" style="padding:5px"> 至 <input type="text" class="datepicker" name="arrange_up_to_day"  size="12" maxlength="50" readonly="readonly" style="padding:5px">
                </span>
            </span>
...
@$from_day=$_REQUEST["arrange_up_from_day"]?get_ymd($_REQUEST["arrange_up_from_day"])["d"]:null;
@$to_day=$_REQUEST["arrange_up_to_day"]?get_ymd($_REQUEST["arrange_up_to_day"])["d"]+24*3600:null;
$where=@array("order_boss_m_bianhao=? and order_addtime>=? and order_addtime<=? and order_type='thsj'",
...
<div class="order">
    <div class="order_inner">
        ...
        <div class="order_table_row2">
            <div class="order_table_row2_item" style="width:40%;"><?php echo $rowitem["detail_p_huohao"]?> / <?php echo $rowfactory["factory_name"]?></div>
