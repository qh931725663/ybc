...
<div class="search_box">
    <div class="search_box_inner_a">
        <div class="dp of lf">
            ...
            <span id="btn_seller_search" onclick="/**/search_products()" class="btn_normal_blue public_search">搜索</span>
            <span class="clear_search" onclick="mount_to_frame('view_products_list',1,'frame_products_list')">清空<br>条件</span>
        </div>
        <div class="rt">
    ...
    <div class="report_table_header" style="background:#f2f2f2">
        ...
        <div style="color:#999999; width:20%; text-align:left;">货号 / 颜色 / 尺码 / 成分</div>
        <div style="color:#999999; width:34%;text-align:left;">工厂 / <span class="sp_a">货号</span> / <span class="sp_b">供货价</span> / 合作模式 / 账期</div>
    ...
    <div class="report_table_body" style="border-bottom:1px dashed #cccccc">
        ...
        <div style="float:left; width:34%; height:25px">
            ...
            <div style="float:left; width:100%; padding:5px 0">
                <span class="lf"><?php echo $rowfactory["factory_name"] ?><?php echo !empty($rowproductfactory["p_barcode_factory_huohao"])?" / <span style='color:#0099ff'>".$rowproductfactory["p_barcode_factory_huohao"]."</span>":"" ?> / <span style="color:#ee583d"><?php echo $rowproductfactory["p_barcode_valueprice"] ?></span> / <?php echo $rowproductfactory["p_barcode_factory_mode"]=="1"?"代销 / ".$rowfactory["factory_cycle"]."天":"经销" ?></span>
                <span class="rt">
        ...
        <div style="float:left; width:8%; padding:10px 0; color:#ee583d"><?php echo $rowpagedata["p_saleprice"]?></div>
        <div style="float:left; width:8%; padding:10px 0; color:#ee583d"><?php echo $rowpagedata["p_vipprice"]?></div>
        <div style="float:left; width:15%">
            <div style="float:left; width:100%; text-align:center; padding:5px 0">
                <span style="color:#0099FF; cursor:pointer" onclick="/**/ShowProductAddFactoryLayer(<?php echo $rowpagedata["p_bianhao"]?>)">添加工厂</span>
            </div>
            <div style="float:left; width:100%; text-align:center; padding:5px 0; display:none;">
                <span style="color:#0099FF; cursor:pointer" onclick="/**/DeleteProduct(<?php echo $rowpagedata["p_bianhao"]?>)">删除商品</span>
            </div>
            <div style="float:left; width:100%; text-align:center; padding:5px 0;">
                <span style="color:#0099FF; cursor:pointer;" onclick="/**/mount_to_frame('view_products_modify?var_p_bianhao=<?php echo $rowpagedata["p_bianhao"]?>',1,'frame_products_list')">修改商品</span>
            </div>
            <div style="float:left; width:100%; text-align:center; padding:5px 0">
                <span style="color:#0099FF; cursor:pointer" onclick="/**/ShowGoodsSellerLayer(<?php echo $rowpagedata["p_bianhao"]?>)">卖家定价</span>
            </div>
        </div>
    </div>
<?php
