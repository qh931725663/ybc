    ...
    <div style="width:98%; margin:20px auto 0 auto; background:#ffffff; border:1px solid #cccccc; overflow:hidden; display:block">
        <div id="warehousepurchaselist_left" style="float:left; width:56%; min-height:800px; padding:0 2%; border-right:1px solid #cccccc; overflow:hidden; display:block">
            ...
            <div style="float:left; width:98%; padding:10px 1%">
                ...
                <span style="float:right">
                    <span style="font-size:18px; color:#999999">数量总计：<span id="warehousepurchase_total_num" style=" font-size:24px; color:#ee583d">0</span></span>
                </span>
            </div>
            ...
            <input type="hidden" id="warehousepurchase_order_master_bianhao" name="order_master_bianhao" value="<?php echo !empty($_SESSION["ERP_ACCOUNT_USER_DANGKOU_BIANHAO"])?$_SESSION["ERP_ACCOUNT_USER_DANGKOU_BIANHAO"]:$order_master_bianhao ?>">
            <input type="hidden" id="warehousepurchase_order_master_name" name="order_master_name" value="<?php echo !empty($_SESSION["ERP_ACCOUNT_USER_DANGKOU_BIANHAO"])?$_SESSION["ERP_ACCOUNT_USER_DANGKOU_NAME"]:$order_master_name ?>">
            </form>                            
        </div>
