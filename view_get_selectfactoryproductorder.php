...
<div style="float:left; width:100%; overflow:hidden; display:block">
    ...
    <div style="float:left; width:100%">
        <div style="float:left; width:100%; margin-top:15px"><span id="select_<?php echo $_REQUEST["var_order_type"]?>_order_num" style="margin:0 5px; font-size:18px; font-weight:bold; color:#ee583d; display:inline-block">0</span>件</div>
    </div>    
    <div style="float:left; width:100%">
...
$(function (){
    $('#btn_<?php echo $_REQUEST["var_order_type"]?>_putintoorderlist').click(function(){
        ...
        <?php
        if ($_REQUEST["var_order_type"]=="stocktransfer")
        {
        ?>
