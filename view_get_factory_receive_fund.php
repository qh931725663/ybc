...
$receivable_fund=$_REQUEST["var_receive_fund"];
?>
                        <form id="form_factory_receive_fund">
                        ...
                        <div style="float:left; width:100%; margin-top:10px; overflow:hidden; display:block">
                            <span id="tip_notice_factory_receive_fund" style="float:left; margin-left:100px"></span>
                        </div>
                        <div style="float:left; width:100%; margin-top:10px; overflow:hidden; display:block">
                            <span onClick="/**/PostFactoryReceiveFund()" style="float:left; margin-left:100px; margin-bottom:50px; padding:7px 20px; background:#ee583d; color:#FFFFFF; cursor:pointer">确认已支付</span>
                        </div>
                        ...
                        <input type="hidden" name="table[1][bill_type]" value="gcsh" />
                        </form>
...
<script>
    function PostFactoryReceiveFund(){
        ...
        $.ajax({
            ...
            type: "POST",
            dataType:"json",
            data:$("#form_factory_receive_fund").serialize(),
            error:function(){
